...
## 2026-08-02T07:19:28.426Z — n1a — BLOCKED
...
```json
{
  ...
  "rule": "BLOCK promotion: protected-file modification detected: ARCHITECTURE_CONTRACTS.md, BOOTSTRAP.md, META_PROMPT.md, docs/contracts/open-decisions.md, docs/design/n2-approval-rev1.md, docs/design/n2-visual-design.md, docs/design/n2-visual-gate-sheet.md, docs/scene/n3-static-scene.md, fb_plan.md, records/approvals/gate-2-n3-approved.md, records/evidence/n17-after-fix.png, records/evidence/n17-articulation-fix.md, records/evidence/n17-before-fix.png, records/evidence/n17-repro-after.json, records/evidence/n17-repro-before.json, records/evidence/n17-visual-review.html, records/evidence/n3-review-camera.png, records/evidence/n3-runtime-report.md, records/evidence/n8-assets.json, records/evidence/n8-merged.json, records/evidence/n8-performance.json, records/evidence/n8-physics.json, records/evidence/n8-regression.json, records/evidence/n8-rounds.json, records/evidence/n8-state.json, records/evidence/n8-visual.json, records/task-packets/N18-physics-ratchet.md, records/task-packets/N19-charter-revision-dynamic-fingers.md, records/task-packets/N20-claw-cycle-classic-arcade.md, src/App.tsx, src/animation/pose-animation.ts, src/animation/travel-animator.ts, src/assets/manifest.ts, src/assets/registry.ts, src/claw/pose-adapter.ts, src/claw/rig.ts, src/effects/n7-coordinator.ts, src/evidence/n3-evidence.ts, src/evidence/n3-runtime-report.json, src/evidence/n3.test.ts, src/evidence/n4-evidence.ts, src/evidence/n4-runtime-report.json, src/evidence/n4.test.ts, src/evidence/n5-evidence.ts, src/evidence/n5.test.ts, src/evidence/n6-evidence.ts, src/evidence/n6-ratchet-report.json, src/evidence/n6-runtime-report.json, src/evidence/n6.test.ts, src/evidence/n7-evidence.ts, src/evidence/n7.test.ts, src/evidence/publish.ts, src/physics/adapter.ts, src/physics/config.ts, src/scene/N3Canvas.tsx, src/scene/StaticScene.tsx, src/scene/config.ts, src/scene/report.ts, src/state/controller.ts, src/styles/global.css, src/types/geometry.ts, CHECKLIST-bugfix-verification.md, PLAN-node-contracts.md, bug_fixes_needed.md, fb_plan_graph.md, docs/archive/m1/CHECKLIST-bugfix-verification.md, docs/archive/m1/PLAN-node-contracts.md, docs/archive/m1/bug_fixes_needed.md, docs/archive/m1/fb_plan.md, docs/archive/m1/fb_plan_graph.md",
  "outcome": "BLOCKED",
  "checkpoint": "n1a:BLOCKED:2026-08-02T07:19:28.290Z",
  "protectedDiff": [
    ...
    "fb_plan.md",
    "records/approvals/gate-2-n3-approved.md",
    "records/evidence/n17-after-fix.png",
    "records/evidence/n17-articulation-fix.md",
    "records/evidence/n17-before-fix.png",
    "records/evidence/n17-repro-after.json",
    "records/evidence/n17-repro-before.json",
    "records/evidence/n17-visual-review.html",
    "records/evidence/n3-review-camera.png",
    "records/evidence/n3-runtime-report.md",
    "records/evidence/n8-assets.json",
    "records/evidence/n8-merged.json",
    ...
    "records/evidence/n8-state.json",
    "records/evidence/n8-visual.json",
    "records/task-packets/N18-physics-ratchet.md",
    "records/task-packets/N19-charter-revision-dynamic-fingers.md",
    "records/task-packets/N20-claw-cycle-classic-arcade.md",
    "src/App.tsx",
    "src/animation/pose-animation.ts",
    "src/animation/travel-animator.ts",
    "src/assets/manifest.ts",
    "src/assets/registry.ts",
    "src/claw/pose-adapter.ts",
    "src/claw/rig.ts",
    ...
    "src/evidence/n5.test.ts",
    "src/evidence/n6-evidence.ts",
    "src/evidence/n6-ratchet-report.json",
    "src/evidence/n6-runtime-report.json",
    "src/evidence/n6.test.ts",
    "src/evidence/n7-evidence.ts",
    "src/evidence/n7.test.ts",
    "src/evidence/publish.ts",
    "src/physics/adapter.ts",
    "src/physics/config.ts",
    "src/scene/N3Canvas.tsx",
    "src/scene/StaticScene.tsx",
    ...
    "CHECKLIST-bugfix-verification.md",
    "PLAN-node-contracts.md",
    "bug_fixes_needed.md",
    "fb_plan_graph.md",
    "docs/archive/m1/CHECKLIST-bugfix-verification.md",
    "docs/archive/m1/PLAN-node-contracts.md",
    "docs/archive/m1/bug_fixes_needed.md",
    "docs/archive/m1/fb_plan.md",
    "docs/archive/m1/fb_plan_graph.md"
  ],
  "missingEvidence": [],
  "checks": [],
  "requiredFields": [
...
## 2026-08-02T07:36:40.972Z — n1a — PASS
...
```json
{
  ...
  "rule": "all required gate rules passed; gate-log.md is gate-owned output",
  "outcome": "PASS",
  "checkpoint": "n1a:PASS:2026-08-02T07:36:03.739Z",
  "protectedDiff": [],
  "missingEvidence": [],
  "checks": [
    {
...
## 2026-08-02T08:54:55.416Z — n21 — PASS

```json
{
  "version": 1,
  "node": "n21",
  "baseline": "opt-baseline-2",
  "routingInput": {
    "node": "n21",
    "baseline": "opt-baseline-2",
    "requestedBaseline": "opt-baseline-2",
    "checks": [
      "typecheck",
      "lint",
      "test",
  ...
  "rule": "all required gate rules passed; gate-log.md is gate-owned output",
  "outcome": "PASS",
  "checkpoint": "n21:PASS:2026-08-02T08:54:06.597Z",
  "protectedDiff": [],
  "missingEvidence": [],
  "checks": [
    {
  ...
  "recordedAt": "2026-08-02T08:54:55.416Z"
}
```
